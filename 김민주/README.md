...
* 📄 **[[김민주-언리얼5.8_MCP_연동_및_미니레이싱_제작_실시간로그]](./wiki/[김민주-언리얼5.8_MCP_연동_및_미니레이싱_제작_실시간로그].md)**
  * 언리얼 엔진 5.8과 Antigravity IDE의 MCP(Model Context Protocol) 연동 및 실시간 디버깅 내역 전수 기록
  * 엔진 소스코드 역분석(`bAutoStartServer=false`, 포트 8000) 및 `mcp_config.json` 복구
  * 함석신 연출/기획의 '미니 레이싱 (빌리지 버전) One Lap Challenge' 아트/물리 구현 진행 상황
  * 3인 2팀 '인간 vs AI' 대결 구도에서의 실증 개발 시간 및 개입 데이터 축적
